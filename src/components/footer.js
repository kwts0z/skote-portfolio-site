  ...
  return (
    <div className="flex flex-col bg-black px-5 justify-center items-center w-full md:items-end md:justify-between md:flex-row">
      <div className='flex h-[7rem] md:pb-2 justify-between md:justify-end md:order-3 w-full md:w-1/3'>
        ...
        <a className="flex h-full w-auto justify-end" target="_blank" rel="noreferrer" href='https://www.linkedin.com/in/georgios-georgakis/'><img className="h-4/5 w-auto transition-all duration-300 hover:scale-125" src={linkedIn} alt='linked in'/></a>
      </div>
